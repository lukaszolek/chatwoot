...
#  index_messages_on_outreach_draft_status              (((additional_attributes ->> 'outreach_draft'::text)), ((additional_attributes ->> 'draft_status'::text))) WHERE (additional_attributes ? 'outreach_draft'::text)
