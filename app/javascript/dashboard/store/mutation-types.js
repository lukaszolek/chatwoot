export default {
  ...
  // Pipeline Stages
  SET_PIPELINE_STAGES_UI_FLAG: 'SET_PIPELINE_STAGES_UI_FLAG',
  SET_PIPELINE_STAGES: 'SET_PIPELINE_STAGES',
  SET_CONTACT_PIPELINE_STAGES: 'SET_CONTACT_PIPELINE_STAGES',
  ...
  // Influencer Profiles
  SET_INFLUENCER_UI_FLAG: 'SET_INFLUENCER_UI_FLAG',
  SET_INFLUENCER_META: 'SET_INFLUENCER_META',
  SET_INFLUENCERS: 'SET_INFLUENCERS',
  SET_INFLUENCER_ITEM: 'SET_INFLUENCER_ITEM',
  APPEND_INFLUENCERS: 'APPEND_INFLUENCERS',
  CLEAR_INFLUENCERS: 'CLEAR_INFLUENCERS',
  EDIT_INFLUENCER: 'EDIT_INFLUENCER',
  SET_INFLUENCER_SEARCH_RESULTS: 'SET_INFLUENCER_SEARCH_RESULTS',
  CLEAR_INFLUENCER_SEARCH_RESULTS: 'CLEAR_INFLUENCER_SEARCH_RESULTS',
  SET_INFLUENCER_LAST_SEARCH_PARAMS: 'SET_INFLUENCER_LAST_SEARCH_PARAMS',
  SET_INFLUENCER_SEARCH_HISTORY: 'SET_INFLUENCER_SEARCH_HISTORY',
  SET_KANBAN_COLUMN: 'SET_KANBAN_COLUMN',
  APPEND_KANBAN_COLUMN: 'APPEND_KANBAN_COLUMN',
  SET_KANBAN_COLUMN_LOADING: 'SET_KANBAN_COLUMN_LOADING',
  CLEAR_KANBAN: 'CLEAR_KANBAN',
  UPDATE_KANBAN_ITEM: 'UPDATE_KANBAN_ITEM',
  REMOVE_KANBAN_ITEM: 'REMOVE_KANBAN_ITEM',
  SET_KANBAN_COLUMN_META_COUNT: 'SET_KANBAN_COLUMN_META_COUNT',

  // Influencer Hashtags
  SET_INFLUENCER_HASHTAGS_UI_FLAG: 'SET_INFLUENCER_HASHTAGS_UI_FLAG',
  SET_INFLUENCER_HASHTAGS: 'SET_INFLUENCER_HASHTAGS',
  UPDATE_INFLUENCER_HASHTAG: 'UPDATE_INFLUENCER_HASHTAG',
  SET_STARRED_HASHTAGS: 'SET_STARRED_HASHTAGS',
